...
export const Heading = ({ children, className, size }: Properties) => {
    ...
    switch (size) {
        case '1': return <h1 className={css}>{children}</h1>;
        case '2': return <h2 className={css}>{children}</h2>;
        case '3': return <h3 className={css}>{children}</h3>;
        case '4': return <h4 className={css}>{children}</h4>;
        case '5': return <h5 className={css}>{children}</h5>;
        case '6': return <h6 className={css}>{children}</h6>;
    }
};
